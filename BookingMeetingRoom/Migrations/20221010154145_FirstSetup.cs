...
namespace BookingMeetingRoom.Migrations
{
    public partial class FirstSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //            .Annotation("SqlServer:Identity", "1, 1"),
            //        FacilitiesName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_ImageRoom", x => x.ImageRoomID);
            //    });
            ...
            //            .Annotation("SqlServer:Identity", "1, 1"),
            //        ObjectiveName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            //        IsDelete = table.Column<bool>(type: "bit", nullable: true),
            //        CreatedBy = table.Column<int>(type: "int", nullable: true),
            //        CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
            //        UpdatedBy = table.Column<int>(type: "int", nullable: true),
            ...
            //        Available_Day = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            //        Available_From = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            //        Available_To = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            //        CreatedBy = table.Column<int>(type: "int", nullable: true),
            //        CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
            //        UpdatedBy = table.Column<int>(type: "int", nullable: true),
            //        UpdatedDate = table.Column<DateTime>(type: "datetime", nullable: true)
            ...
            //    columns: table => new
            //    {
            //        RoomFacilitiesID = table.Column<int>(type: "int", nullable: false)
            //            .Annotation("SqlServer:Identity", "1, 1"),
